...
public class BitacoraCultivo {
    ...
    public BitacoraCultivo(Long id, Long cultivoAgricultorId, Long tipoActividadId,
                           ...
                           LocalDate fechaCreacion, String cultivo) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Builder cultivoAgricultorId(Long v) { o.cultivoAgricultorId = v; return this; }
        public Builder tipoActividadId(Long v)     { o.tipoActividadId = v;     return this; }
        public Builder tipoNombre(String v)        { o.tipoNombre = v;          return this; }
        public Builder tipoIcono(String v)         { o.tipoIcono = v;           return this; }
        public Builder alertaId(Long v)            { o.alertaId = v;            return this; }
        public Builder descripcion(String v)       { o.descripcion = v;         return this; }
        public Builder fechaActividad(LocalDate v) { o.fechaActividad = v;      return this; }
        public Builder fechaCreacion(LocalDate v)  { o.fechaCreacion = v;       return this; }
        public Builder cultivo(String v)           { o.cultivo = v;             return this; }
        
        public BitacoraCultivo build()             { return o; }
    }
