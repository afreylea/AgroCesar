...
public class AlertaMapper implements RowMapper<Alerta> {
    ...
    public Alerta map(ResultSet rs, StatementContext ctx) throws SQLException {
        ...
        return Alerta.builder()
            ...
            .fechaDiaPronostico(fechaDiaPronostico != null ? fechaDiaPronostico.toLocalDate() : null)
            .fechaGeneracion(fechaGeneracion != null ? fechaGeneracion.toLocalDateTime() : null)
