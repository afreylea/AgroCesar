...
--  1. SECUENCIAS
-- ============================================================
CREATE SEQUENCE SEQ_MUNICIPIOS          START WITH 0 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_USUARIOS            START WITH 0 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CULTIVOS_CATALOGO   START WITH 0 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_CULTIVOS_AGRICULTOR START WITH 0 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_ALERTAS             START WITH 0 INCREMENT BY 1 NOCACHE NOCYCLE;
